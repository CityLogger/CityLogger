export default function Terms() {
  return <main className="legal-page">
    ...
    <p className="legal-placeholder">Developer action required before release: this placeholder must be reviewed and completed for the operating business and target countries.</p>
    <h2>Your account</h2>
    ...
    <p>The service may change as it develops. You may download your data or permanently delete your account from the app’s Account & Privacy settings.</p>
    <h2>Contact</h2>
    <p>[LEGAL CONTACT DETAILS TO BE COMPLETED]</p>
  </main>;
}
